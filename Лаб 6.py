...
# Все варианты выбора женщин и мужчин для первых двух спец.
for w in combinations(women, 2):
    rest1 = set(all_candidates) - set(w)
    for m in combinations(rest1 & set(men), 2):
        rest2 = rest1 - set(m)
        # Все перестановки оставшихся на третью спец.
